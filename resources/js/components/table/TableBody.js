...
import TableShoppingListCascadeOption from './TableShoppingListCascadeOption';
import { deleteRecipe, favoriteRecipe } from '../../actions/recipes';
import { addNewShoppingListItem, removeShoppingListItem } from '../../actions/shoppingList';
...
export class TableBody extends React.Component {
    ...
    addShoppingListItem = (shopping_list_id, ingredient_id) => {
        this.props.addNewShoppingListItem({ shopping_list_id, ingredient_id });
    }

    removeShoppingListItem = (shopping_list_item_id) => this.props.removeShoppingListItem(shopping_list_item_id);
                                        ...
                                        { this.props.options.map((option) => {
                                            ...
                                            switch(option.onClick) {
                                                ...
                                                case 'updateShoppingList':
                                                    return (
                                                        <TableShoppingListCascadeOption
                                                            key={"option_" + option.label + "_" + item.id}
                                                            id={ item.id }
                                                            option={ option }
                                                            onAddItem={ this.addShoppingListItem }
                                                            onRemoveItem={ this.removeShoppingListItem }
...
const mapDispatchToProps = (dispatch) => ({
	...
	removeShoppingListItem: (params) => dispatch(removeShoppingListItem(params))
});
